...
#define rb_color(r) ((r)->size & 0b1)
#define rb_is_red(r)   ((r)->size & 0b1 ==RED)
#define rb_is_black(r)  ((r)->size & 0b1 ==BLACK)
#define rb_set_black(r)  do { (r)->size |= BLACK; } while (0)
#define rb_set_red(r)  do { (r)->size &= (~RED); } while (0)
#define rb_set_parent(r,p)  do { (r)->parent = (p); } while (0)
#define rb_set_color(r,c)  if(c){ (r)->size |= BLACK;} else (r)->size &= (~RED);
